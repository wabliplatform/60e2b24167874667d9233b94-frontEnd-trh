...
(function(root, factory) {
  ...
  describe('Patients', function() {
    it('should create an instance of Patients', function() {
      // uncomment below and update the code to test Patients
      //var instane = new TempApi.Patients();
      //expect(instance).to.be.a(TempApi.Patients);
    });

    it('should have the property id (base name: "_id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TempApi.Patients();
